...
namespace ImageValidation.Client.Validation
{
    public class UserInfo : NotifyingObject
    {
        ...
        [Required(ErrorMessageResourceName = "UsernameInclude", ErrorMessageResourceType = typeof(ErrorResources))]        
        ...
        [Required(ErrorMessageResourceName = "PasswordInclude", ErrorMessageResourceType = typeof(ErrorResources))]
