...
namespace ImageValidation.Validator.Validation
{
    public class NotifyingObject : INotifyPropertyChanged, IDataErrorInfo
    {
        #region Fields
        ...
        protected virtual string OnValidate(string propertyName)
        {
            ...
            if (propertyName.Equals("Password"))
            {
                ...
                {
                    return "Password length could not be less than 4";
                }
            ...
            if (propertyName.Equals("PasswordConfirmation"))
            {
                if (value.ToString().Length < 4)
                {
                    return "Confirm Password length could not be less than 4";
                }

                string pwd = GetValue("Password").ToString();
                if (!pwd.Equals(value))
                {
            ...
            if (propertyName.Equals("DateOfBirth"))
            {
                ...
                try
                {
                    ...
                    if (Convert.ToDateTime(value.ToString()) < dt)
                    {
                        return "The birth date is invalid.";
                    }
                }
